...
import com.compititionapp.personlize.network.Sort__1
...
class StudyMaterial {
    ...
    override fun toString(): String {
        return "StudyMaterial(content=$content, pageable=$pageable, totalElements=$totalElements, totalPages=$totalPages, last=$last, size=$size, number=$number, sort=$sort, numberOfElements=$numberOfElements, first=$first, empty=$empty)"
    }
