...
class TestList {
    ...
    override fun toString(): String {
        return "TestList(content=$content, pageable=$pageable, last=$last, totalPages=$totalPages, totalElements=$totalElements, size=$size, number=$number, sort=$sort, numberOfElements=$numberOfElements, first=$first, empty=$empty)"
    }
